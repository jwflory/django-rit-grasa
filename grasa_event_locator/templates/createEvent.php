      ...
      <div class="form-row">
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    <input id="name" type="text" class="form-control" placeholder="Name..." name="title" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" rows="8" placeholder="Tell us about your program..."  name="content" required></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="location" placeholder="Street Address..." name="address" required>
                    <div class="invalid-feedback">
                        Please provide your programs street address.
                    </div>
                </div>
                <div class="form-group">
                    <label for="website">Website (optional)</label>
                    <input type="url" class="form-control" id="website" placeholder="http://" name="website">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group text-left multiBox">
                    <label for="activity">Activity</label><br>
                    <select id="activity" class="form-control custom-select w-100 activitySelect" multiple="multiple" name="activity" required>
                    </select>
                    <div class="invalid-feedback">
                ...
                <div class="form-group text-left multiBox">
                    ...
                    <select id="grades" class="custom-select w-100 gradesSelect" multiple="multiple" name="grades" required>
                    </select>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input id="fees" type="number" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="0.00" name="fees" required>
                        <div class="invalid-feedback">
                ...
                <div class="form-group text-left multiBox">
                    ...
                    <select id="timing" class="custom-select w-100 timingSelect" multiple="multiple" name="timing" required>
                    </select>
                     <div class="invalid-feedback">
