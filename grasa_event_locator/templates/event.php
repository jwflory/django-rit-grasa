...
<div class="container event-container">
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <p><b>Contact Information: </b> <br><i class="fa fa-user" aria-hidden="true"></i> {{ event.contact_name }} <br><i class="fa fa-envelope" aria-hidden="true"></i> {{ event.contact_email }} <br><i class="fa fa-phone" aria-hidden="true"></i> {{ event.contact_phone }}</p>
        ...
        <div class="col-sm-4">
            <div class="card event-page-card">
              ...
              <ul class="list-group list-group-flush">
                ...
                {% endif %}
                {% if event.address %}
                <a target="_blank" href="https://maps.google.com/?q={{ event.address }}"><li class="list-group-item"><i class="fa fa-map-marker" aria-hidden="true"></i>{{ event.address }}</li></a>
                {% else %}
              ...
              <div class="card-body">
              {% if event.website %}
                 <a target="_blank" href="{{ event.website }}" class="card-link"><i class="fa fa-globe" aria-hidden="true"></i> {{ event.website }}</a>
              {% else %}
                <div class="card-link"><i class="fa fa-globe" aria-hidden="true"></i> Not Provided
              {% endif %}
              </div>
            </div>
        </div>
